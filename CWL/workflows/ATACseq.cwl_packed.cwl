            ...
            "outputs": [
                {
                    ...
                    "outputBinding": {
                        "glob": "$(inputs.bam.nameroot + \".bedpe\")"
                    }
                }
            ],
            ...
            "outputs": [
                {
                    ...
                    "outputBinding": {
                        "glob": "$( inputs.fastq1.nameroot + \".bowtie2_stderr\")"
                    }
                },
                {
                    "type": "File",
        ...
        },
        {
            ...
            "outputs": [
                ...
                },
                {
                    ...
                    "outputBinding": {
                        "glob": "$( inputs.sample_id + \".plot_fingerp.stderr\")"
                    }
                },
                {
                    "type": [
                ...
                },
                {
                    ...
                    "in": [
                        ...
                        },
                        {
                            ...
                            "id": "#main/generating_coverage_tracks/reference_info"
                        }
                    ],
                    "out": [
        ...
        },
        {
            ...
            "outputs": [
                ...
                },
                {
                    ...
                    "outputBinding": {
                        "glob": "$(inputs.bam.nameroot + \".phantompeakqualtools_stderr\")"
                    }
                },
                {
                    "type": "File",
                    ...
                    "outputBinding": {
                        "glob": "$(inputs.bam.nameroot + \".phantompeakqualtools_stdout\")"
                    }
                }
            ],
            "successCodes": [
        ...
        },
        {
            ...
            "outputs": [
                ...
                },
                {
                    ...
                    "outputBinding": {
                        "glob": "$(inputs.bam_sorted.nameroot + \".picard_markdup.log\")"
                    }
                }
            ],
            ...
            "outputs": [
                {
                    ...
                    "outputBinding": {
                        "glob": "$(inputs.bam.nameroot + inputs.output_suffix)"
                    }
                }
            ],
            ...
            "outputs": [
                {
                    ...
                    "outputBinding": {
                        "glob": "$(inputs.bam_unsorted.basename)"
                    }
                }
            ],
            ...
            "outputs": [
                {
                    ...
                    "outputBinding": {
                        "glob": "$(inputs.bam.nameroot)_filt.bam"
                    }
                }
            ],
